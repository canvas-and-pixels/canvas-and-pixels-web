...
const projects: Project[] = [
  ...
  },
  {
    id: 2,
    title: 'Focuslog',
    tags: ['Mobile development', 'Product design', 'Pomodoro', 'Productivity', 'AI'],
    image: '/peony.png',
    gradient: 'from-pink-500 to-rose-500',
    description: 'A productivity and time tracker application that helps keep track of time, with analytics and AI support.',
    client: 'Focuslog',
    duration: '6 months (2024)',
    technologies: ['Flutter', 'Database', '', 'AI', 'PostgreSQL', 'Firebase', 'Supabase'],
